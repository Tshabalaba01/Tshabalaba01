export default class BudgetTracker {
                ...
                <tbody>
                    <tr>
                        <td colspan="5" class="controls">
                            <button type="button" class="new-entry">Lägg till</button>
                        </td>
                    </tr>
                </tbody>
                <tfoot>
    ...
    static entryHtml() {
        return `
            <tr>
                ...
                <td>
                    <input class="input input-description" type="text" placeholder="Lägg till Beskrivning">
                </td>
                <td>
    ...
    updateSummary() {
        ...
        const totalFormatted = new Intl.NumberFormat("sv-SV", {
            style: "currency",
            currency: "SEK"
        }).format(total);
